...
// The summary is a user turn: Anthropic-shaped endpoints require the first
// non-system message to be from the user, and the snapped boundary usually makes
// the retained tail start with an assistant turn.
